...
public class makeIndianPokerGui extends JPanel {
    ...
    public makeIndianPokerGui() {
        ...
        int opponentCardnum = new Random().nextInt(10) + 1; 
        String opponentCardName = String.valueOf(opponentCardnum);
        ...
        playerCard = new JLabel(loadImage("images/Indian_Poker_"+opponentCardName+".png", 150, 130)); 
