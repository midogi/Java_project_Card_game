...
public class makeBlackJackGUI extends JPanel {
    ...
    public makeBlackJackGUI() {
        ...
        hitButton.addActionListener(e -> {
            ...
            if (playerScore > 21){
                dealerHiddenCardLabel.setIcon(loadImage("cards/" + dealerCards.get(0) + ".png", 100, 150));
                determineWinner();
                restartGame();
            }
    ...
    private void updateCardDisplay(){
        ...
        for(int i=0;i<playerCards.size();i++){
            ...
            cardLabel.setIcon(loadImage("cards/" + playerCards.get(i) + ".png", 100, 150));
        ...
        for(int i=0;i<dealerCards.size();i++){
            ...
            if(i==0) {
                dealerHiddenCardLabel.setIcon(loadImage("cards/card_back.png", 100, 150)); // 뒷면 카드
                dealerCardImagePanel.add(dealerHiddenCardLabel);
            }
            else{
                cardLabel2.setIcon(loadImage("cards/" + dealerCards.get(i) + ".png", 100, 150));
